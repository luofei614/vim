...
elseif borders[max(keys(borders))] == 'colon'
    ...
    elseif prop == 'transform'
        let values = ["scale(","rotate(","rotateX(","rotateY(","rotateZ(","translate(","translateX(","translateY(","translateZ(","skew(","perspective(","matrix("]
    ...
    elseif prop == 'border-image'
        let values = ["none", "url(", "stretch", "repeat", "round"]
    elseif prop == 'background-origin'
        let values = ["border", "padding", "content"]
    elseif prop == 'background-clip'
        let values = ["border-box", "padding-box", "content-box", "no-clip"]
    elseif prop == 'background-size'
        let values = ["auto{1,2}", "cover", "contain"]
    elseif prop == 'opacity'
        let values = ["inherit"]
    ...
    elseif prop == 'box-sizing'
        let values = ["content-box", "border-box", "inherit"]
    elseif prop == 'resize'
        let values = ["none", "both", "horizontal", "vertical", "inherit"]
    elseif prop == 'outline'
        let values = ["inherit"]
    elseif prop == 'outline-width'
        let values = ["thin", "medium", "thick"]
    elseif prop == 'outline-style'
        let values = ["none", "dotted", "dashed", "solid", "double", "groove", "ridge", "inset", "outset"]
    elseif prop == 'outline-offset'
        let values = ["inherit"]
    elseif prop == 'outline-color'
        let values = ["inherit"]
    elseif prop == 'nav-index'
        let values = ["auto", "inherit"]
    elseif prop == 'nav-up'
        let values = ["auto", "inherit"]
